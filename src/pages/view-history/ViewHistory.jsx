...
export const ViewHistory = () => {
  ...
  // GET allocation history by assetId
  const fetchHistory = async () => {
    if (!assetId) {
      setError("Asset ID URL mein nahi mili.");
      setHistory([]);
      return;
    }
    ...
    try {
      ...
      const response = await allocationService(assetId);

      // API response ko handle karna
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="View asset allocation and return records"
        actions={
